...
def create_gui(filtered_image):
    ...
    colormap_buttons = [
        ...
        ("Copper", create_copper_colormap, "copper.png"),
        ("Magma", create_magma_colormap, "magma.png")
    ]
...
def start_page(root):
    ...
    # Logo
    logo_image = tk.PhotoImage(file="C:/Users/Usama Tariq/Desktop/Scanimation.png")
